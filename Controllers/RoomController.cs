...
namespace Midterm.Controllers
{
    public class RoomController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomId,RoomName,IsHidden,RoomTypeId")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomId,RoomName,IsHidden,RoomTypeId")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
